...
//
//
// By default bionode will fetch the full xml records where possiblew and otherwise
// use the default value of the db. To get fasta sequences you must specify fasta
// via the rettype option.
